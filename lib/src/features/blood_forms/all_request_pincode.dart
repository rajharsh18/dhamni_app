...
class AllRequestPincode extends StatefulWidget {
  @override
  _AllRequestPincodeState createState() => _AllRequestPincodeState();
}

class _AllRequestPincodeState extends State<AllRequestPincode>
              ...
              if (snap.connectionState == ConnectionState.done) {
                if (snap.hasData) {
                  ...
                  return FutureBuilder<List<BloodModel>>(
                    future: controller.getPincodeRequest(pin_user, email_user),
